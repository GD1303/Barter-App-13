...
export default class ExchangeScreen extends React.Component {
    ...
    getIsExchangeRequestActive = () => {
        //get if the user already has one request active
    ...
    addItem = (itemName, description) => {
        //create a request doc in firebase
    ...
    getData = () => {
        fetch('http://data.fixer.io/api/latest?access_key=33b865d477370ac1364cab0473086a79&format=1')
        .then(response => {
